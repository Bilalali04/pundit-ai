...
SYSTEM_PROMPT = (
    ...
    "matchup's real numbers, not a generic template that could apply to any two teams. Feature "
    ...
    "form alone are a complete, valid explanation for many matchups. Also be upfront that the "
    "prediction is based on historical data through last season, not this season's live form - "
    "the offline dataset it's computed from doesn't update with current-season matches."
)
